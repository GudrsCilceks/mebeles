...
namespace mebeluveikals
{
    public class FurnitureManager
    {
        ...
        public void UpdateFurniture(string name, string description, double price,
    int height, int width, int length)
        {
            using (var connection = new SqliteConnection(connectionString))
            {
            ...
            UPDATE Furniture
            SET Description = @description, Price = @price, Height = @height, Width = @width, Length = @length
            WHERE Name = @name";
